...
export default {
    ...
    data() {
        return {
            paes: null,               //os 2 primeiros dados que vem do server
            carnes: null,
            opcionaisdata: null,
            nome: null,             //dados que são enviados para o server
            pao: null,
            carne: null,
            opcionais: [],
            msg: null,
    ...
    methods: {
        ...
        async createBurger(e) {  
            ...
            const data = {
                ...
                carne: this.carne,
                pao: this.pao,
                opcionais: Array.from(this.opcionais),    //o opcionais é um array, precisa do Array.from()
                status: "Solicitado"
            }
